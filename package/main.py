...
APP_NAME = os.getenv("APP_NAME", "文衡工作台")
...
if os.path.exists(STATIC_DIR):
    ...
    async def serve_root():
        ...
        return {"message": f"{APP_NAME} API", "version": "1.0.0"}
...
DEFAULT_TASK_CONCURRENCY_LIMIT=1
...
"""
        ...
        print("   请编辑此文件，填入 API Key，并妥善保存管理员密码")
